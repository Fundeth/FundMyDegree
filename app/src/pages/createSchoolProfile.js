...
const CreateSchoolProfile = () => {
  ...
  const [accreditation, setAccreditation] = useState(profile?.get("accreditation"));
  const [schoolContact, setSchoolContact] = useState(profile?.get("schoolContact"));
  const [schoolContactEmail, setschoolContactEmail] = useState(profile?.get("schoolContactEmail"));
  const [schoolContactPhone, setschoolContactPhone] = useState(profile?.get("schoolContactPhone"));
  ...
  function goNextPage() {
    ...
    if(page === 0){
      ...
      var propForm = {firstName:firstName, website:website, email:email, schoolphone:schoolphone, page:page, errorMessage:errorMessage,errorMessage1:errorMessage1, flag:flag}
      propForm= ValidateForm(propForm);
    };

    if(page === 1){
      console.log("inside gonext page 1")
      var propForm = {address1:address1, city:city, state:state, country:country, postalCode:postalCode, page:page, errorMessage:errorMessage,errorMessage1:errorMessage1, flag:flag}
      propForm= ValidateForm(propForm);
    };

    if(page === 2){
      console.log("inside gonext page 2")
      var propForm = {schoolContact:schoolContact, schoolContactEmail:schoolContactEmail, schoolContactPhone:schoolContactPhone, page:page, errorMessage:errorMessage,errorMessage1:errorMessage1, flag:flag}
      propForm= ValidateForm(propForm);
    };

    if(page === 3){
      console.log("inside gonext page 3")
      var propForm = {accreditation:accreditation, page:page, errorMessage:errorMessage,errorMessage1:errorMessage1, flag:flag}
      propForm= ValidateForm(propForm);
    };      
    ...
    if(propForm.flag === true){
    ...
    else
      {
        ...
        document.getElementById('div_element').innerHTML = propForm.errorMessage.toString();
        document.getElementById('div_element1').innerHTML = propForm.errorMessage1.toString();
      }
  }
