  ...
  return (
    <div>
      <div className="flex flex-col justify-center text-center  sticky">
        ...
        {props.page !== 0 && numFields > 0 && (
          <button
            className="flex-row h-12 items-center border-b-2 border-l-2 border-r-2 border-greyfmd2 hover:bg-gray-100 outline-none"
            onClick={() => {
              props.setPage(0);
            }}
          >
        ...
        {props.page === 3 && numFields > 3 && (
          <button className="flex-row h-12 items-center border-b-2 border-l-2 border-green-600 border-r-2  text-green-600 font-bold outline-none">
            {props.fieldGroups[3]}
          </button>
        )}
        {props.page !== 3 && numFields > 3 && (
        ...
        {props.page !== 4 && numFields > 4 && (
          <button
            className="flex-row h-12 items-center border-b-2 border-l-2 border-r-2 border-greyfmd2 hover:bg-gray-100 rounded-b-lg outline-none"
            onClick={() => {
              props.setPage(4);
            }}
          >
